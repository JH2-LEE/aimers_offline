...
infer_model.load_state_dict(torch.load("/root/workspace/minkyung/ckpt/dlinear_submit_0916_2.pth"))
...
submit_mall1.to_csv("/root/workspace/minkyung/submit/dlinear_submit_0916_1.csv", index=False)
