...
infer_model.load_state_dict(torch.load("/root/workspace/kuka2/PatchTST/ckpt/patchtst_submit_0917_2_epoch2.pth"), strict=False)
...
submit_mall1.to_csv("/root/workspace/songseong/patchtst_submit_0917_2.csv", index=False)
