...
DATA_DIRECTORY_CITY = "/home/vil/jihui/data1/Cityscapes"
DATA_LIST_PATH_EVAL = (
    "/home/vil/jihui/data1/Foggy_Zurich/lists_file_names/RGB_testv2_filenames.txt"
)
...
DATA_DIR_EVAL = "/home/vil/jihui/data1"
DATA_DIR_EVAL_FD = "/home/vil/jihui/data1/Foggy_Driving"
NUM_CLASSES = 19
RESTORE_FROM = "no model"
SNAPSHOT_DIR = f"/home/vil/jihui/data1/snapshots/FIFO"
GT_DIR_FZ = "/home/vil/jihui/data1/Foggy_Zurich"
GT_DIR_FD = "/home/vil/jihui/data1/Foggy_Driving"
GT_DIR_CLINDAU = "/home/vil/jihui/data1/Cityscapes/gtFine"
SPLIT = "val"
...
def get_arguments():
    ...
    parser.add_argument(
        "--data-list-eval-fdd", type=str, default=DATA_LIST_PATH_EVAL_FDD
    )
    ...
    parser.add_argument("--set", type=str, default=SPLIT)
    ...
    parser.add_argument(
        "--devkit-dir-fz", default="/home/vil/jihui/data1/Foggy_Zurich/lists_file_names"
    )
