...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gt-dir", type=str, help="directory which stores CityScapes val gt images"
    )
    parser.add_argument(
        "--pred-dir", type=str, help="directory which stores CityScapes val pred images"
    )
    parser.add_argument(
        "--devkit_dir",
        default="/home/vil/jihui/data1/Foggy_Zurich/lists_file_names",
        help="base directory of zurich",
    )
