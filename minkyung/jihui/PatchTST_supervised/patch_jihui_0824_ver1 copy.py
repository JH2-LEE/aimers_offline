...
# torch.save(infer_model.state_dict(), "./patchtst_submit_0824_ver1_2.pth")
...
infer_model.load_state_dict(torch.load("./patchtst_submit_0824_ver1_2.pth"))
...
submit.iloc[:, 1:] = pred
submit.to_csv("./patchtst_submit_0824_1.csv", index=False)
