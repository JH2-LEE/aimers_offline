...
# torch.save(infer_model.state_dict(), "./patchtst_submit_0823_ver4.pth")
...
infer_model.load_state_dict(torch.load("./patchtst_submit_0823_ver4.pth"))
...
submit.iloc[:, 1:] = pred
submit.to_csv("./patchtst_submit_0823_ver4.csv", index=False)
