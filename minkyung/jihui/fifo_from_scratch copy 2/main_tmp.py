...
start_iter = 0
## segmentation
model = rf_lw101(num_classes=args.num_classes).to(args.gpu)
        ...
        if args.modeltrain == "train":
            ...
            for idx, layer in enumerate(fsm_weights):
                ...
                for batch_idx in range(4):
                    ...
                    # if i_iter % 3 == 0:
                    # print("cw gram size:", a_gram.size())
                    # Fog Style Matching Loss
                    # if i_iter % 3 == 1 or i_iter % 3 == 1:
                    # print("rf gram size:", a_gram.size())

                    if i_iter % 3 == 1 or i_iter % 3 == 2:  # rf-sf or rf-cw
