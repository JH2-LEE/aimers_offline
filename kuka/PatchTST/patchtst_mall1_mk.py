    ...
    for epoch in range(1, CFG["EPOCHS"] + 1):
        ...
        if best_loss > val_loss:  # val loss가 가장 작은 모델을 저장
            ...
            torch.save(
                ...
                "/root/workspace/minkyung/ckpt/patchtst_mall1_submit_0917_4_epoch{}.pth".format(epoch),
            )
    return best_model
...
torch.save(infer_model.state_dict(), "/root/workspace/minkyung/ckpt/patchtst_mall1_submit_0917_4.pth")
