...
infer_model.load_state_dict(torch.load("/root/workspace/minkyung/ckpt/dlinear_submit_0916_2_final.pth"))
...
submit_mall2 = submit.iloc[idx_number]
submit_mall2.iloc[:, 1:] = pred
submit_mall2.to_csv("/root/workspace/minkyung/submit/dlinear_submit_0916_2.csv", index=False)
