...
infer_model.load_state_dict(torch.load("/root/workspace/kuka/PatchTST/patchtst_submit_0916_1_epoch11.pth"), strict=False)
...
submit_mall1.to_csv("/root/workspace/songseong/submit/patchtst_17000_submit_0916_1_epoch11", index=False)
