...
infer_model.load_state_dict(torch.load("/root/workspace/minkyung/ckpt/dlinear_submit_0917_1_epoch2.pth"))
...
submit_mall1.to_csv("/root/workspace/minkyung/submit/dlinear_submit_0916_1_2.csv", index=False)
