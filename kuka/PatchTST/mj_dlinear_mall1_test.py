...
infer_model.load_state_dict(torch.load("/root/workspace/minkyung/ckpt/dlinear_submit_0916_1.pth"))
...
for idx in range(len(pred)):
    ...
    #print(pred[idx, :])
    #print('######scale_idx##########')
    #print(scale_max_dict[idx], scale_min_dict[idx])
    pred[idx, :] = (
...
submit.iloc[:, 1:] = pred
submit.to_csv("/root/workspace/minkyung/submit/dlinear_submit_0916_1.csv", index=False)
